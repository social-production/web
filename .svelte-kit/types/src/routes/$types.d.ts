...
type LayoutRouteId = RouteId | "/" | "/channels/[slug]" | "/communities/[slug]" | "/create/channel" | "/create/community" | "/create/event" | "/create/post" | "/create/project" | "/create/thread" | "/events/[slug]" | "/messages" | "/notifications" | "/onboarding" | "/personal" | "/platform" | "/posts/[id]" | "/profile/[username]" | "/projects/[slug]" | "/roadmap" | "/search" | "/settings" | "/stewardship" | "/threads/[slug]" | null
type LayoutParams = RouteParams & { slug?: string; id?: string; username?: string }
