...
function PersonalFeed($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<section class="feed-page svelte-1u8r7zn"><div class="header-block svelte-1u8r7zn"><h1 class="svelte-1u8r7zn">Personal</h1> <p class="svelte-1u8r7zn">This timeline follows people instead of tags. Use it for direct social posting and followed-user public activity.</p> <div class="divider svelte-1u8r7zn"></div></div> <div class="filters svelte-1u8r7zn"><button${attr_class("filter svelte-1u8r7zn", void 0, { "active": activeFilter === "all" })} type="button">All</button> <button${attr_class("filter svelte-1u8r7zn", void 0, { "active": activeFilter === "activity" })} type="button">Public Activity</button> <button${attr_class("filter svelte-1u8r7zn", void 0, { "active": activeFilter === "posts" })} type="button">Posts</button> <button${attr_class("filter svelte-1u8r7zn", void 0, { "active": activeFilter === "events" })} type="button">Events</button></div> <div class="controls-row svelte-1u8r7zn"><label class="control-field svelte-1u8r7zn"><span class="svelte-1u8r7zn">Sort by</span> `);
    ...
    $$renderer2.push(`</label> <label class="control-field svelte-1u8r7zn"><span class="svelte-1u8r7zn">Window</span> `);
    ...
    $$renderer2.push(`</label></div> <div class="stack svelte-1u8r7zn">`);
    if (visibleItems.length === 0) {
      $$renderer2.push("<!--[0-->");
      $$renderer2.push(`<section class="empty-card svelte-1u8r7zn"><p class="svelte-1u8r7zn">No posts or activity match this filter yet.</p></section>`);
    } else {
      $$renderer2.push("<!--[-1-->");
      $$renderer2.push(`<!--[-->`);
