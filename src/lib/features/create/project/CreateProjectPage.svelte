  ...
  async function handleCreate() {
    ...
    try {
      ...
      const result = await createProject({
        ...
        locationIsOnline: locationIntent === 'online',
        providerPlaceId: locationIntent === 'physical' ? locationValue.providerPlaceId : null,
        latitude: locationIntent === 'physical' ? locationValue.latitude : null,
        longitude: locationIntent === 'physical' ? locationValue.longitude : null,
        region: locationIntent === 'physical' ? locationValue.region : null,
        country: locationIntent === 'physical' ? locationValue.country : null,
