<script lang="ts">
  ...
  import { addEventUpdate } from '$lib/services/queries/details';
  ...
  async function submitUpdate() {
    ...
    try {
      await addEventUpdate(data.slug, draftUpdateTitle, draftUpdateBody);
      draftUpdateTitle = '';
      draftUpdateBody = '';
...
<section class="updates-shell" id="updates">
  ...
  {#if data.viewerIsEventManager && showUpdateComposer}
