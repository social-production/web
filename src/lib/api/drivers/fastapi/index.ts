...
export function createFastApiDriver(): AppAdapter {
  return {
    ...
    async planProjectServiceRequest(_slug, _requestId, _input) { return fetchPlanProjectServiceRequest(); },
    async requestProjectServiceRequestSettingsChange(_slug, _input) { return fetchRequestProjectServiceRequestSettingsChange(); },
    async setProjectServiceRequestSettingsChangeVote(_slug, _requestId, _vote) { return fetchSetProjectServiceRequestSettingsChangeVote(); },
    async toggleProjectServiceHistoryCompletion(_slug, _historyId, _role, _selection) { return fetchToggleProjectServiceHistoryCompletion(); },
